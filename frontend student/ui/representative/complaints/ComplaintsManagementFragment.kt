package com.example.mess.ui.representative.complaints
...
import com.example.mess.databinding.FragmentComplaintsManagementBinding
import com.example.mess.ui.complaints.Complaint
import com.example.mess.ui.complaints.ComplaintAction
import com.example.mess.ui.complaints.ComplaintStatus
import com.example.mess.ui.complaints.ComplaintStatusAdapter
        ...
        complaintsListener = FirebaseHelper.complaintsRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (complaintSnapshot in snapshot.children) {
                    ...
                    val imageUrl = complaintSnapshot.child("imageUrl").getValue(String::class.java)
                ...
                val sortedComplaints = complaints.sortedWith(compareBy<Complaint> { 
                ...
                adapter.updateComplaints(sortedComplaints)
            }
